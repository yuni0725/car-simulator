from simulations.graphics import *
from simulations.entities import RectangleEntity, CircleEntity, RingEntity
            ...
            if agent.movable or not self.visualized_imgs:
                if isinstance(agent, RectangleEntity):
                    ...
                    img = CircleRing(
                        ...
                        self.ppm * agent.inner_radius,
                        self.ppm * agent.outer_radius,
                    )
                else:
