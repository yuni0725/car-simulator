...
from simulations.agents import Car, RectangleBuilding, Pedestrian, Painting
...
# For both of these objects, we give the center point and the size.x
...
if not human_controller:
    ...
    for k in range(400):
        ...
        if (
            ...
            k == 200
        ):  # The first Car starts pushing the brake a little bit. The second Car starts turning right with some throttle.
