...
class CarSimulations(gym.Env):
    ...
    def step(self, action_index):
        ...
        # ✅ Reward for speed (scaled down)
        speed = self.car.speed
        reward += speed * 0.02

        reward += self.x_dist_to_goal * 0.1

        # ✅ Reward for progress toward goal (scaled down)
        ...
        # ✅ Penalty for steering (scaled down)
        reward -= abs(self.steering) * 0.005

        # ✅ Penalty for stagnation (scaled down)
        ...
        # ✅ Terminal conditions with scaled rewards/penalties
